...
#| tbl-cap: "Breakdown of counts of job ads by rank and tenure status. Values in parentheses are for the United States only. TT = tenure-track, NTT = non-tenure-track. Not all ads include unambiguous information about tenure status, so the sum of TT and NTT does not equal the sum of all jobs in all ranks." 
