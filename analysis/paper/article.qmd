...
library(usethis)
use_git_config(user.name = "Jess Beck")
---
...
=======
The aim of this paper is to TEACH JESS HOW TO USE QUARTO AND GITHUB, UNFORTUNATELY FOR JESS. <!-- It would be nice if you could make comments in the visual mode and not just in source mode, unfortunate --> We had two aims: to determine if disciplinary trends can be discerned in the topical, geographic, and method foci of the positions advertised; and to investigate how the requirements for applicants have changed over time.
>>>>>>> 6bd6da2157f429e8fb7bf1453fed18ccb6b5cd59
