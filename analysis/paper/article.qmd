...
One way that some hiring committees are tackling these biases towards prestigious institutions is to provided detailed instructions to applicants on how to prepare their application materials so that the hiring committee can evaluate and rank the specific accomplishments of candidate across a variety of categories, rather than ranking based on prestige of the candidates' graduate schools. This has resulted in job ads that are highly prescriptive in the types of documents that applicants should submit. For example, in addition to a cover letter and CV, job ads in many fields now require applicants to submit short statements about their teaching and research record and plans. In a comparison of job ads from 1999–2000 and 2019–2020 published in _Anthropology News_ @HelloTristesTropes2021 noticed a trend toward increasingly asking for more materials from applicants. They found that twice as many 2019–2020 job ads requested writing samples compared to 1999–2000, and nearly four times as many requested statements of teaching philosophy. In their review of the 'worst job ads of 2021' @dennisWorstAnthroJob2022 reported two job ads with extreme requirements, requesting nine and thirteen documents from applicants. A notable requirement that has emerged in recent years is a diversity statement, where the applicant describes their knowledge of, prior contributions to, and future goals for advancing diversity, equity, inclusion. This requirement has been much-debated due to an experiment during 2016-2022 at several University of California campuses that used diversity statements as the first cut for selecting candidates for tenure-track faculty positions [@soucek2021diversity]. Only candidates that scored highly on their diversity statements would have the rest of their application evaluated. This experiment generated intense and widespread public debate about merits and risks of requiring and using diversity statements, drawing attention to the challenges of hiring faculty from underrepresented minorities, and resulting in some prestigious universities no longer requiring diversity statements for job applicants [@guidenAreDiversityStatements].  
