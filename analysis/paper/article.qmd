...
#| fig-cap: "A: total number of job ads posted to the Academic Jobs Wiki for Archaeology in each year, with coloured sections showing the proportion of jobs by title and rank. B: Ratio of tenure-track to non-tenure-track positions over time.The proportion of the bar above the red line reflects the number of non-tenure track positions available relative to tenure-track positions."
#JB: I have added the last sentence above because I have not seen this kind of figure in an archaeology paper, so I think we should explain it. Will reduce friction for our readers.Please confirm that I am actually correctly explaining how the figure works, however.
#JB: I would be eternally grateful if you would convert the hyphens between the timespans on the x-axis into en dashes 😬
...
The academic job market is a source of uncertainty, for both job seekers and hiring committees. Job seekers must search for ads that are well-matched to the skill sets and professional experiences that they have taken years to cultivate. Hiring committeesmust sift through tens to hundreds of applicants in the hope of finding a candidate that meets all of their needs and helps to realize<!--We should go with American spelling, no? With your Australian inclinations and my growing incorporation of Irish orthography into my writing, this paper is gonna be a mess...--> their visions of their program and the discipline. Finding the right candidate for the position—or the right position for the candidate—is akin to finding a needle in a haystack.
...
We collected data from `r total_number_of_ads_in_our_sample` ads for tenure-track jobs in archaeology posted during 2013-2023. We focus our analysis here on the `r total_number_of_us_ads_in_our_sample` ads for positions at US universities because <!--Ben,we should provide the rationale for this, I don't remember what it was-->. @fig-show-basic-plots shows the count of ads for each year. Assistant Professor jobs are consistently the most common title and rank of positions advertised, while open rank or full professor are the least frequent. The ratio of tenure-track to non-tenure track positions is generally well above one; in other words, this data set is dominated by tenure-track positions . Only academic year 2013-2014 had more non-tenure track positions than tenure-track positions <!--I know that this is a pedantic complaint, but we should be consistent about whether or not we hyphenate tenure-track-->, which was followed by an upward trend peaking at 2018-2019 and then declining again into the present.
...
#JB: Interesting that Near East is on the up and up. You know what I am going to say about the timespans in the x-axis…
...
#JB: Please. The x-axis. My fragile mental state.

#JB: Given that not all job ads are categorised by all foci, can we provide an overall n for Figure 3 for and 5, either in the captions or in the figures themselves? I assume that 20% of our “methods” sample is not the same as 20% of our “topics” sample.
