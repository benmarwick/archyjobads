...
The aim of this paper is to TEACH JESS HOW TO USE QUARTO AND GITHUB, UNFORTUNATELY FOR JESS. We had two aims: to determine if disciplinary trends can be discerned in the topical, geographic, and method foci of the positions advertised; and to investigate how the requirements for applicants have changed over time.
